...
z = ds['altitude'].isel({'trajectory': 0}).values * units.meters
...
skewt.plot(None, np.array(z), th, np.array(p)*100, qv, np.array(u), np.array(v), 'sounding.pdf', title=os.path.basename(file))